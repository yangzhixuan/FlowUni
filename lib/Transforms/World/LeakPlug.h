...
namespace leakplug{
    ...
    struct LeakPlug: public FunctionPass {
        ...
        static void freeOnEdge(const LeakAnalysis& la, LeakAnalysis::PtrNode head, LeakAnalysis::PtrNode tail, Instruction* resourceInst);
        static void patchSourceCode(const LeakAnalysis& la, Value* resource, const Instruction* insertBefore);
    };

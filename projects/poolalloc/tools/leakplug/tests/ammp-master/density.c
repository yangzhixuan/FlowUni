...
typedef  struct
{
float xo,yo,zo,x,y,z; /* the coordinates of the line */
int ixo,iyo,ix,iy;  /* transformed copies in pixels */
float txo,tyo,tzo, tx,ty,tz; /* tranformed copies */
}  CONTOUR_ELEMENT;

#define MAX_BUNCH 10000
typedef struct
{
void CONTOUR_ELEMENT c[MAX_BUNCH];
GdkColor *pen;
int inme;
void *next;
}  BUNCH ;
...
void DENSITY_scan_density( FILE *ip,float level, GdkColor *pen)
{
